      ...
      <div className="flex flex-col justify-center items-center w-full">
        ...
        <div data-aos="fade-down" data-aos-delay="300" className="text-center">
          ...
          <h1
            data-aos="fade-down"
            data-aos-delay="750"
            className="text-white text-5xl sm:text-7xl lg:text-7xl font-bold pt-1"
          >
            Contact
          </h1>
          <div className="">
            <p
              data-aos="fade-down"
              data-aos-delay="1600"
              className="text-white text-base sm:text-sm mb-6 lg:text-lg pt-6 pb-4"
            >
              I&apos;m actively applying for <span className="link">Summer 2024 internships.</span> and if you&apos;re in the market for a <br></br> motivated and eager individual, look no further! My skills and qualifications<br></br> may align with what you&apos;re looking for, so drop me a message and let&apos;s chat<br></br> about potential opportunities.
            </p>
