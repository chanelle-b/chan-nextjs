...
const ProjectSection = () => {
  ...
  return (
    <section
        id="projects"
        className="flex flex-col items-center w-full px-4 sm:px-10 md:pt-32 lg:pt-64"
    >
        ...
        <div data-aos="fade-down" data-aos-delay="300" className="pb-4  ">
          <div className="flex flex-col items-center">
            <div className="card gradient-border p-0.2 inline-block -mt-8">
              <div
                  className="card2 content border border-purple-400 p-4 text-white hover:text-black bg-black text-transparent bg-clip-text bg-gradient-to-r from-purple-900 via-blue-400 to-pink-500">
              ...
              <div className="flex flex-col items-center">
                <div className="card gradient-border p-0.2 inline-block">
                  <div
                    ...
                    <div class="flex justify-center items-center">
                      <a href="https://github.com/chanelle-b/Party-Manager"
                         class="transition-transform duration-200 hover:scale-125">
                        <svg
                            stroke-linejoin="round"
                            stroke-linecap="round"
          ...
          <div className="flex flex-col items-center">
            <div className="card gradient-border p-0.2 inline-block ">
              <div className="card2 content border border-purple-400 p-4 text-white hover:text-purple-300">
                ...
                <div class="flex justify-center items-center">
                  <a href="https://github.com/chanelle-b/AI-Chatbot"
                     class="transition-transform duration-200 hover:scale-125">
                    <svg
                        stroke-linejoin="round"
                        stroke-linecap="round"
